...
test('cast test', function() {
	...
	ok( sg.schema.cast('', Date) == null, "cast a String as a Date" );
	...
	ok( sg.schema.cast('+11.5',   Number, 2.3) == 2.3,  "cast a String as a Number" );
	ok( sg.schema.cast('1+11.5',  Number) == undefined,  "cast a String as a Number" );
...
test('schema test 1', function(){
	...
	ok( anObjectWithaSchemaApplied.dob2.getDate() == new Date().getDate(), 'dob should equal 340725600000' );
